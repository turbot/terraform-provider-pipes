...
func TestAccUserPreferences_Basic(t *testing.T) {
	resourceName := "pipes_user_preferences.test"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_community_updates", "enabled"),
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_product_updates", "enabled"),
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_tips_and_tricks", "enabled"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_community_updates", "disabled"),
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_product_updates", "enabled"),
					resource.TestCheckResourceAttr(
						"pipes_user_preferences.test", "communication_tips_and_tricks", "enabled"),
...
func testAccUserPreferencesConfig() string {
	return `
		resource "pipes_user_preferences" "test" {
